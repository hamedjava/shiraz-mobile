...
export const HeroSection = () => {
  return (
    // اصلاح: حذف فونت غیر استاندارد و استفاده از کلاس‌های Tailwind که به وزیرمتن اشاره دارند
    <section className="relative w-full min-h-[85vh] flex items-center bg-slate-50 overflow-hidden">
      
      {/* 1. BACKGROUND EFFECTS */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-[size:40px_40px]"></div>
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
         <div className="absolute -top-[10%] -left-[10%] w-1/2 h-1/2 bg-brand-yellow/10 rounded-full blur-[120px]" />
      </div>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-16 lg:gap-0">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-right z-20 mt-8 lg:mt-0">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-[5rem] font-black text-slate-900 leading-[1.1] tracking-tight mb-6">
              آیفون ۱۷ پرو <br />
              <span className="text-brand-yellow">فراتر از واقعیت</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center lg:justify-start">
              <Link href="/products/iphone-17-pro" className="group w-full sm:w-auto h-14 px-10 rounded-2xl bg-brand-yellow text-slate-900 font-bold text-lg flex items-center justify-center gap-2 transition-all hover:bg-[#FCE24D] hover:shadow-[0_10px_20px_-5px_rgba(255,215,0,0.4)] hover:-translate-y-1">
                پیش‌خرید کنید
          ...
          <div className="w-full lg:w-1/2 relative flex justify-center items-center h-[600px]">
             ...
             <div className="absolute z-0 w-[500px] h-[500px] rounded-full border-t border-r border-transparent border-l-brand-yellow/40 border-b-brand-yellow/10 animate-[spin_20s_linear_infinite]"></div>
             ...
             <div className="relative z-10 w-[360px] h-[360px] rounded-full bg-white shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border-[8px] border-white flex items-center justify-center overflow-hidden">
                <div className="relative w-full h-full rounded-full overflow-hidden bg-slate-50">
                    {/* توجه: این عکس باید در پوشه public/images/products/ قرار گیرد */}
                    <img src="/images/products/iphone17mainPic.png" alt="iPhone 17 Pro Max" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" />
                </div>
             </div>
             <div className="absolute w-[500px] h-[500px] animate-[spin_20s_linear_infinite]">
                <div className="w-3 h-3 bg-brand-yellow rounded-full absolute top-[50%] -right-1.5 shadow-[0_0_10px_#FFD700]"></div>
             </div>
             <div className="absolute -right-2 top-1/2 -translate-y-[140px] z-30 bg-white p-2.5 pr-4 rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border border-slate-100 flex items-center gap-3 animate-[bounce_3s_infinite]">
                <div className="w-8 h-8 rounded-lg bg-brand-yellow flex items-center justify-center text-slate-900">
